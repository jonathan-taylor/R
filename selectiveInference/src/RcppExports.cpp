...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(solve_QP(Sigma, bound, maxiter, theta, linear_func, gradient, ever_active, nactive, kkt_tol, objective_tol, parameter_tol, max_active, kkt_stop, objective_stop, param_stop));
    return rcpp_result_gen;
END_RCPP
}
// solve_QP_wide
Rcpp::List solve_QP_wide(Rcpp::NumericMatrix X, Rcpp::NumericVector bound, double ridge_term, int maxiter, Rcpp::NumericVector theta, Rcpp::NumericVector linear_func, Rcpp::NumericVector gradient, Rcpp::NumericVector X_theta, Rcpp::IntegerVector ever_active, Rcpp::IntegerVector nactive, double kkt_tol, double objective_tol, double parameter_tol, int max_active, int kkt_stop, int objective_stop, int param_stop);
RcppExport SEXP _selectiveInference_solve_QP_wide(SEXP XSEXP, SEXP boundSEXP, SEXP ridge_termSEXP, SEXP maxiterSEXP, SEXP thetaSEXP, SEXP linear_funcSEXP, SEXP gradientSEXP, SEXP X_thetaSEXP, SEXP ever_activeSEXP, SEXP nactiveSEXP, SEXP kkt_tolSEXP, SEXP objective_tolSEXP, SEXP parameter_tolSEXP, SEXP max_activeSEXP, SEXP kkt_stopSEXP, SEXP objective_stopSEXP, SEXP param_stopSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< int >::type objective_stop(objective_stopSEXP);
    Rcpp::traits::input_parameter< int >::type param_stop(param_stopSEXP);
    rcpp_result_gen = Rcpp::wrap(solve_QP_wide(X, bound, ridge_term, maxiter, theta, linear_func, gradient, X_theta, ever_active, nactive, kkt_tol, objective_tol, parameter_tol, max_active, kkt_stop, objective_stop, param_stop));
    return rcpp_result_gen;
END_RCPP
}
// update1_
